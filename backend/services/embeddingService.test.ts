  ...
  describe('createEmbedding', () => {
    ...
    describe('error handling', () => {
      it('should log error and rethrow when API call fails', async () => {
        ...
        expect(mockLogError).toHaveBeenCalledWith('Failed to create embedding', apiError)
      })
      ...
      it('should handle network errors', async () => {
        ...
        expect(mockLogError).toHaveBeenCalledWith('Failed to create embedding', networkError)
      })
      ...
      it('should handle invalid API key errors', async () => {
        ...
        expect(mockLogError).toHaveBeenCalledWith('Failed to create embedding', authError)
      })
      ...
      it('should handle rate limiting errors', async () => {
        ...
        expect(mockLogError).toHaveBeenCalledWith('Failed to create embedding', rateLimitError)
      })
